// / l79FAA1FC_0 Values
    ...
    slope_resist = false;               // Value for resisting the slope influence
    ...
    dropdash_timer = DROPDASH_INIT;		// Dropdash charge delay timer
    ...
    last_debug = false;                 // Hacky fix to reset player when debug mode is deactivated
    ...
    knux_gravity = true;               // Flag used to enable and disable gravity for knuckles
    ...
    jump_anim_stretch = 1.68;            // Sets squash and stretch when Sonic jumps
    jump_anim_stretch_speed = 0.08;
